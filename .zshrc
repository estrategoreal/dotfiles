...
alias ide='gvim +"set columns=173" +"VimFiler -buffer-name=explorer -simple -toggle $HOME" +tabnew +TlistOpen +"VimFiler -buffer-name=explorer -split -simple -winwidth=45 -toggle -no-quit"'
